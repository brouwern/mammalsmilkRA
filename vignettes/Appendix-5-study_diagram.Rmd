---
title: "Appendix 5) Study Diagrams (.pptx)"
...
Meta-analyses often have flow charts showing how an initial pool of studies was screen for inclusion in the analysis.  The [PRISMA guidlines](http://prisma-statement.org/) (Preferred Reporting Items for Systematic Reviews & Meta-Analyses) recommend a 4-phase flow diagram be included in meta-analyses to describe the process of finding, screening, and extracting data from papers in a meta anlaysis.  See [Libarati et al 2009](https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1000100)
...
THe paper below has an interesting flow chart about how samples were shared accross three labs to test for biases in lab techniques.  The ends result was a retraction of a [Cell paper!](https://retractionwatch.com/2016/12/27/harvard-biologist-retracts-diabetes-breakthrough-cell/)
